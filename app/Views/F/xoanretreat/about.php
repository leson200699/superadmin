...
<main>
    ...
    <?php endforeach; ?>
    <section class="h-[300px] md:h-[450px] bg-cover bg-center" style="background-image: url('https://placehold.co/1920x450/aa8877/ffffff?text=Sunset+View+Banner');" data-aos="zoom-in" data-aos-duration="1000">
    </section>
