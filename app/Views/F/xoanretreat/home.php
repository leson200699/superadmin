...
<!--     <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4 grid md:grid-cols-3 gap-12 text-center">
            <div data-aos="fade-up" data-aos-delay="100">
                <div class="text-4xl text-amber-600 mb-4"><i class="fa-solid fa-trees"></i></div>
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                <div class="text-4xl text-amber-600 mb-4"><i class="fa-solid fa-house-tree"></i></div>
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                <div class="text-4xl text-amber-600 mb-4"><i class="fa-solid fa-hands-praying"></i></div>
     ...
     <section class="py-16">
        <div class="container mx-auto px-4 text-center">
             <h2 class="text-3xl font-bold mb-2" data-aos="fade-down">XOAN RETREAT</h2>
             <p class="text-gray-600 mb-12 max-w-3xl mx-auto" data-aos="fade-down" data-aos-delay="100">Xoan Retreat chào mừng bạn đến với khu nghỉ nhỏ xinh nằm ẩn mình giữa những tán cây xanh bên bờ hồ Hòa Bình.</p>
         ...
         <div class="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
             <div class="md:w-1/2" data-aos="fade-right">
                 <div class="bg-gray-300 h-80 flex items-center justify-center text-gray-500 rounded-lg">
                     <img src="/uploads/58/tien-ich.jpg">
                 </div>
             </div>
             <div class="md:w-1/2" data-aos="fade-left">
                 <!-- <h2 class="text-3xl font-bold mb-4">XOAN RETREAT</h2> -->
                 <p class="text-gray-600 mb-6">Xoan Retreat hân hạnh mang đến những dịch vụ đạt chuẩn, được xây dựng trên nền tảng của sự tận tâm và thân thiện từ đội ngũ nhân viên. Chúng tôi cam kết đem lại cho khách hàng những trải nghiệm tuyệt vời.</p>
                 <div class="grid grid-cols-2 gap-x-8 gap-y-4 text-gray-700 text-sm">
                    <div class="flex items-center space-x-2"><span><i class="fa-solid fa-wifi"></i></span><span>WIFI MIỄN PHÍ</span></div>
                    <div class="flex items-center space-x-2"><span><i class="fa-solid fa-mug-saucer"></i></span><span>QUẦY CAFÉ</span></div>
                    <div class="flex items-center space-x-2"><span><i class="fa-solid fa-fork-knife"></i></span><span>NHÀ HÀNG</span></div>
                    <div class="flex items-center space-x-2"><span><i class="fa-solid fa-person-swimming"></i></span><span>BỂ BƠI VÔ CỰC</span></div>
                    <div class="flex items-center space-x-2"><span><i class="fa-solid fa-circle-parking"></i></span><span>BÃI ĐỖ XE CÓ MÁI CHE</span></div>
                    <div class="flex items-center space-x-2"><i class="fa-solid fa-mug-saucer"></i><span>ĂN SÁNG MIỄN PHÍ</span></div>
                    <div class="flex items-center space-x-2"><span><i class="fa-solid fa-leaf"></i></span><span>SÀN YOGA</span></div>
                   <!--  <div class="flex items-center space-x-2"><span><i class="fa-solid fa-grill-hot"></i></span><span>BBQ NGOÀI TRỜI</span></div> -->
                 </div>
             </div>
         </div>
     </section>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-amber-600 font-semibold mb-4">TỪ <?=number_format($product->price);?>₫ / ĐÊM</p>
        ...
        <div class="container mx-auto px-4 text-center">
             ...
             <div class="grid md:grid-cols-1 gap-8">
                 <div class="relative rounded-lg overflow-hidden shadow-lg" data-aos="fade-right">
                     <div class="bg-gray-300 h-72 flex items-center justify-center text-gray-500"><img src="/uploads/58/bg-2.jpg"></div>
                     <div class="absolute inset-0 bg-black bg-opacity-30 flex flex-col items-center justify-end p-6 text-white">
                         <h3 class="text-2xl font-semibold mb-4">TRẢI NGHIỆM</h3>
                         <p class="mb-4">Xoan Retreat là một chốn biệt lập, nơi hòa quyện âm thanh, nhịp sống và những chuyển động độc đáo. Thong dong thả câu bên hồ nước yên bình, băng qua những lối mòn rừng xanh, lướt nhẹ trên kayak giữa lòng hồ tĩnh lặng, hoặc tĩnh tâm thiền định trên đỉnh đồi thoáng đãng... mỗi khoảnh khắc không chỉ là cơ hội chiêm ngưỡng nét đẹp Tây Bắc mà còn là hành trình khám phá bản thân giữa vòng tay thiên nhiên.</p>
