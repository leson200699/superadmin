                    ...
                    <div class="form-section">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                             ...
                             <!-- <div>
                                <label class="form-label">Tải ảnh lên (0/5)</label>
                     ...
                     <!-- Location and Time -->
                    <div class="form-section">
                        <h2 class="text-xl font-bold mb-6 text-blue-800">Địa điểm và Thời gian</h2>
                        <div class="space-y-4">
                             <div>
                ...
                <div class="max-w-xl mx-auto">
                     <div class="flex items-start space-x-3">
                        ...
                        <label for="privacy-policy" class="text-sm text-gray-600">
                            Tôi đồng ý cho phép Công ty TNHH Kinh doanh Thương mại và Dịch vụ VinFast xử lý dữ liệu cá nhân của tôi và các thông tin khác do tôi cung cấp cho mục đích và theo phương thức được mô tả chi tiết tại Chính sách Bảo vệ Dữ liệu cá nhân.
                        </label>
                    </div>
