...
<div x-data="newsFormData()" @select-image.window="handleImageSelection($event.detail)">
    <div class="max-w-2xl mx-auto space-y-8">
        <div class="bg-white p-6 rounded-lg shadow space-y-6">
            <h1 class="text-2xl font-semibold text-gray-800 mb-4 flex items-center"><i class="fas fa-folder-plus mr-2"></i> Thêm danh mục tour mới</h1>
            ...
            <?php endif; ?>
            <form action="/admin/tourcategories/store" method="post" class="space-y-4">
                <div>
                ...
                <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm flex items-center"><i class="fas fa-save mr-2"></i> Lưu danh mục</button>
            </form>
        </div>
    </div>
