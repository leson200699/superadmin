    ...
    <div class="bg-white p-6 rounded-lg shadow space-y-6">
      <div class="flex justify-between items-center border-b pb-4">
        <h1 class="text-2xl font-semibold text-gray-800 flex items-center">
          <i class="fas fa-folder-plus mr-2"></i> <?= lang('validation.add_category') ?>
        </h1>
      ...
      <form action="<?= route_to('admin-news-category-post') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div>
          ...
          <select name="parent" id="parent" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-3 px-4 text-base">
        ...
        <div>
          ...
          <div class="flex gap-4">
            <label class="inline-flex items-center">
              <input type="radio" class="w-5 h-5 text-blue-600 border-gray-300 focus:ring-blue-500" name="status" value="1" checked>
              <span class="ml-2">Hoạt động</span>
            </label>
            <label class="inline-flex items-center">
              <input type="radio" class="w-5 h-5 text-blue-600 border-gray-300 focus:ring-blue-500" name="status" value="0">
