    ...
    <div class="row g-5">
        <div class="col-xl-12">
            <ol class="breadcrumb fs-sm mb-2">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sửa buổi học</li>
            </ol>
            <h2 class="main-title mb-3">Sửa buổi học cho <?= esc($course['title']) ?></h2>
            <p class="text-secondary mb-5">Cập nhật thông tin buổi học.</p>
            ...
            <div class="card card-body">
                ...
                <form action="<?= site_url("admin/courses/update-lesson/{$course['id']}/{$lesson['id']}") ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="form-group row d-flex justify-content-center">
                        <label for="title" class="col-sm-2 col-form-label text-right">Tên buổi học</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="title" id="title" value="<?= esc($lesson['title']) ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" name="content" id="content" rows="4"><?= esc($lesson['content']) ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex justify-content-center">
                        <div class="col-sm-6 offset-sm-2">
                            ...
                            <a href="<?= site_url("admin/courses/show/{$course['id']}") ?>" class="btn btn-secondary">Quay lại</a>
                        </div>
                    </div>
                </form>
            </div>
