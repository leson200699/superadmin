...
<div x-data="newsFormData()" @select-image.window="handleImageSelection($event.detail)">
    <h1 class="text-xl md:text-2xl font-semibold text-gray-800 mb-6">
        <?= lang('validation.add_user') ?>
    </h1>
    <form action="/admin/team/store" method="post" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white p-5 rounded-lg shadow">
                    <div class="mb-2">
                        ...
                        <input type="text" name="fullname" required class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-3 px-4 text-base" placeholder="Nhập tên...">
                    </div>
                    ...
                    <div class="space-y-6 mb-2">
                        <div class="bg-white p-5 rounded-lg shadow">
                            <div>
                                ...
                                <textarea name="description" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 py-3 px-4 text-base" placeholder="Giới thiệu ngắn về thành viên..."></textarea></div>
                        </div>
                    </div>
                    <div>
